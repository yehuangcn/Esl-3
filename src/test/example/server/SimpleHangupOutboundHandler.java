...
/**
 * Simple server of a handler for server connection from FreeSWITCH server.
 * This class will log some of the FreeSWTICH call channel variables and then
 * hangup the call.
 *
 * @author david varnes
 */
public class SimpleHangupOutboundHandler extends AbstractEslServerHandler {
