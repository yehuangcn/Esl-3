 ...
 */
package com.freeswitch.esl.transport;
...
public class SendMsg {
	...
	/**
	 * Constructor for use with server socket client only. This client mode
	 * does not need a call UUID for context.
	 */
	public SendMsg() {
	...
	/**
	 * Constructor for use with the handler client.
	 * 
	 * @param uuid
	 *            of the call to send message to (it should be in 'park' to be
	 *            operated on).
	 */
	 ...
	 * 
	 * @param command
	 *            the string command [ execute | hangup ]
	 */
	 ...
	 * 
	 * @param count
	 *            the int number of times to loop
	 */
