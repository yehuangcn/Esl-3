 ...
 * server, to iterate all bytes of a buffer, you can do the following,
 ...
 * {@link ChannelBuffer}, and no source index is specified, the specified
 * buffer's {@link #readerIndex() readerIndex} is increased together.
 * <p>
...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
	 ...
	 * {@link #writerIndex(int)} methods. For server, the following code will
	 * fail:
	 *
	 * <pre>
	 ...
	 * Otherwise:
	 * <ul>
	 * <li>a non-dynamic buffer will throw an
