 ...
 * {@link com.freeswitch.netty.buffer.ChannelBuffer}, has been designed from ground
 ...
 * accessing unsigned values and strings and searching for certain byte sequence
 * in a buffer. You can also extend or wrap existing buffer type to add
 ...
 * arbitrary number of existing buffers with no memory copy. For server, a
 ...
 * when you build a {@link java.lang.String}. You often estimate the length of
 * the resulting string and let {@link java.lang.StringBuffer} expand itself on
 ...
 * complicated boundary check and index compensation, and therefore it is easier
 * for a JVM to optimize the buffer access. More complicated buffer
 ...
 */
package com.freeswitch.netty.buffer;
