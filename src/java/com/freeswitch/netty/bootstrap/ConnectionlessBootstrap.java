 ...
 * <p>
 * This bootstrap is for connectionless transports only such as UDP/IP. Use
 * {@link ServerBootstrap} instead for connection oriented transports. Do not
 * use this helper if you are using a connection oriented transport such as
 * TCP/IP and local transport which accepts an incoming connection and lets the
 * accepted child channels handle received messages.
 * <p>
 ...
 * <p>
 * {@link ConnectionlessBootstrap} is just a helper class. It neither allocates
 * nor manages any resources. What manages the resources is the
 * {@link ChannelFactory} implementation you specified in the constructor of
 * {@link ConnectionlessBootstrap}. Therefore, it is OK to create as many
 * {@link ConnectionlessBootstrap} instances as you want with the same
...
public class ConnectionlessBootstrap extends Bootstrap {
     ...
     * {@code "remoteAddress"} and the current {@code "localAddress"} option. If
     * the {@code "localAddress"} option is not set, the local address of a new
     * channel is determined automatically. This method is identical with the
     * following code:
     * <p>
     * <pre>
     * {@link ConnectionlessBootstrap} b = ...;
    ...
    /**
     * Creates a new connected channel with the specified
     * {@code "remoteAddress"} and the specified {@code "localAddress"}. If the
     * specified local address is {@code null}, the local address of a new
