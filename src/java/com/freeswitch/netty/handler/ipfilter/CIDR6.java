...
public class CIDR6 extends CIDR {
     ...
     * @throws IllegalArgumentException if the address is not an IPv6 address.
     */
     ...
     * @throws UnknownHostException if the big integer is too large, and thus an invalid IPv6
     *                              address.
     */
