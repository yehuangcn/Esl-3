...
/**
 * The Interface IpFilteringHandler. A Filter of IP. <br>
 * Users can add an {@link IpFilterListener} to add specific actions in case a
 * connection is allowed or refused.
 */
