 ...
 * <br>
 * <p/>
 * Take care to not change isBlocked method except if you know what you are
 * doing since it is used to test if the current closed connection is to be
 * removed or not from the map of currently connected channel.
 */
@Sharable
