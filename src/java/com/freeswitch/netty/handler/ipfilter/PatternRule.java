 ...
 * 
 * <br>
 * Example: allow localhost: <br>
 * new PatternRule(true, "n:localhost") <br>
 * Example: allow local lan: <br>
 * new PatternRule(true, "i:192.168.0.*") <br>
 * Example: block all <br>
 * new PatternRule(false, "n:*") <br>
 */
public class PatternRule implements IpFilterRule, Comparable<Object> {
	 ...
	 *
	 * @param allow
	 *            indicates if this is an allow or block rule
	 * @param pattern
	 *            the filter pattern
	 */
