 ...
 * (CIDR-Notation) and (InetAddress,Mask) where Mask is a integer for
...
public class IpV4Subnet implements IpSet, Comparable<IpV4Subnet> {
     ...
     * i.e.: IpV4Subnet subnet = new IpV4Subnet("10.10.10.0/24"); or IpV4Subnet
     * subnet = new IpV4Subnet("10.10.10.0/255.255.255.0");
     *
