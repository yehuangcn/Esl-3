...
/**
 * The Class IpFilterRuleList is a helper class to generate a List of Rules from
 * a string. In case of parse errors no exceptions are thrown. The error is
 * logged. <br>
 * Rule List Syntax: <br>
 * 
 * <pre>
 ...
 * 
 * <br>
 * Example: allow only localhost: <br>
