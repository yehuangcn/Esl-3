...
public abstract class SimpleTrustManagerFactory extends TrustManagerFactory {
	...
	/**
	 * {@link SimpleTrustManagerFactorySpi} must have a reference to
	 * {@link SimpleTrustManagerFactory} to delegate its callbacks back to
	 * {@link SimpleTrustManagerFactory}. However, it is impossible to do so,
	 * because {@link TrustManagerFactory} requires
	 * {@link TrustManagerFactorySpi} at construction time and does not provide
	 * a way to access it later.
	 *
	 * To work around this issue, we use an ugly hack which uses a
	 * {@link ThreadLocal}.
	 */
	private static final ThreadLocal<SimpleTrustManagerFactorySpi> CURRENT_SPI = new ThreadLocal<SimpleTrustManagerFactorySpi>() {
		@Override
	 ...
	 *
	 * @param name
	 *            the name of this {@link TrustManagerFactory}
	 */
