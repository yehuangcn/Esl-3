 ...
 * {@link ExecutionHandler} (like {@link OrderedMemoryAwareThreadPoolExecutor}
 * or {@link MemoryAwareThreadPoolExecutor}).
 * </p>
 * <p>
 ...
 * among all channels.</b> For instance, if you have a
 * {@link ChannelPipelineFactory}, you should create a new
 ...
 * (except the timer internal itself) by calling:<br>
 * <tt>myHandler.releaseExternalResources();</tt><br>
 * </li>
 * <li>In your handler, you should consider to use the
 * {@code channel.isWritable()} and {@code channelInterestChanged(ctx, event)}
 * to handle writability, or through
 * {@code future.addListener(new ChannelFutureListener())} on the future
 * returned by {@code channel.write()}.</li>
 * <li>
 * <p>
