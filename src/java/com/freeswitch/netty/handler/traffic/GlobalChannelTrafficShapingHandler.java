...
public class GlobalChannelTrafficShapingHandler extends AbstractTrafficShapingHandler {
	 ...
	 *            ObjectSizeEstimator to use
	 * @param timer
	 *            the {@link Timer} to use for the {@link TrafficCounter}.
	 * @param writeLimit
	 *            write Global Limit 0 or a limit in bytes/s
	 * @param readLimit
	 *            read Global Limit 0 or a limit in bytes/s
	 * @param writeChannelLimit
	 *            0 or a limit in bytes/s
	 * @param readChannelLimit
	 *            0 or a limit in bytes/s
	...
	/**
	 * @param maxDeviation
	 *            the maximum deviation to allow during computation of average,
	 *            default deviation being 0.1, so +/-10% of the desired
	 *            bandwidth. Maximum being 0.4.
	 * @param slowDownFactor
	 *            the factor set as +x% to the too fast client (minimal value
	 *            being 0, meaning no slow down factor), default being 40%
	 *            (0.4).
	 * @param accelerationFactor
	 *            the factor set as -x% to the too slow client (maximal value
	 ...
	 *            the maximum Global Write Size allowed in the buffer globally
