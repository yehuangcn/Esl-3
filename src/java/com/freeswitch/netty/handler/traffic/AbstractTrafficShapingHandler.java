...
import com.freeswitch.netty.channel.SimpleChannelHandler;
import com.freeswitch.netty.logging.InternalLogger;
import com.freeswitch.netty.logging.InternalLoggerFactory;
import com.freeswitch.netty.util.DefaultObjectSizeEstimator;
...
public abstract class AbstractTrafficShapingHandler extends SimpleChannelHandler implements ExternalResourceReleasable {
	 ...
	 *
	 * @param timer
	 *            created once for instance like HashedWheelTimer(10,
	 ...
	 *            channels or 0 if no stats are to be computed.
	 * @param maxTime
	 *            The max time to wait in case of excess of traffic (to prevent
	 ...
	 *
	 * @param maxWriteDelay
	 *            the maximum Write Delay in ms in the buffer allowed before
	 ...
	 *
	 * @param maxWriteSize
	 *            the maximum Write Size allowed in the buffer per channel
