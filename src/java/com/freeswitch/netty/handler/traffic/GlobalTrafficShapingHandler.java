 ...
 * global traffic shaping, that is to say a global limitation of the bandwidth,
 ...
 * must be shared among all channels.</b>
 * </p>
 * <p>
 * <p>
 ...
 * {@link OrderedMemoryAwareThreadPoolExecutor} or
 ...
 * <li>
 * <p>
 * When you shutdown your application, release all the external resources by
 * calling:
 * </p>
...
public class GlobalTrafficShapingHandler extends AbstractTrafficShapingHandler {
     ...
     *                           for all channels before write suspended is set, default value
     *                           being 400 MB.
     */
    ...
    private void sendAllValid(ChannelHandlerContext ctx, final PerChannel perChannel, final long now) throws Exception {
        Channel channel = ctx.getChannel();
        if (!channel.isConnected()) {
            // ignore
            return;
