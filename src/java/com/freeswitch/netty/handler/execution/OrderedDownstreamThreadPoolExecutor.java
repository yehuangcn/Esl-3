 ...
 * This implementation will take care of preserve the order of the events in a
 * {@link Channel}. If you don't need to preserve the order just use one of the
 * {@link Executor} implementations provided by the static methods of
 * {@link Executors}. <br>
 * <br>
