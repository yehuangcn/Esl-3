 ...
 * events from the same channel. For server, the event A2 is never executed
 ...
 * mind that the key can appear again after calling
 ...
 * synchronized {@link WeakHashMap} instead of managing the life cycle of the
 * keys by yourself.
 *
 * @apiviz.landmark
 */
