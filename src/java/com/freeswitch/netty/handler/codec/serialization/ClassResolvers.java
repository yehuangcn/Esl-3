...
public final class ClassResolvers {
     ...
     * cache disabled
     *
     * @param classLoader - specific classLoader to use, or null if you want to revert
     *                    to default
    ...
    /**
     * agressive non-concurrent cache good for non-shared cache, when we're not
     * worried about class unloading
     *
     * @param classLoader - specific classLoader to use, or null if you want to revert
     *                    to default
     * @return new instance of class resolver
    ...
    /**
     * non-agressive concurrent cache good for shared cache, when we're worried
     * about class unloading
     *
     * @param classLoader - specific classLoader to use, or null if you want to revert
     *                    to default
     * @return new instance of class resolver
    ...
    /**
     * agressive concurrent cache good for shared cache, when we're not worried
     * about class unloading
     *
     * @param classLoader - specific classLoader to use, or null if you want to revert
     *                    to default
