...
/**
 * An {@link ObjectInput} which is interoperable with {@link ObjectEncoder} and
 * {@link ObjectEncoderOutputStream}.
 */
public class ObjectDecoderInputStream extends InputStream implements ObjectInput {
     ...
     *
     * @param in the {@link InputStream} where the serialized form will be read
     *           from
     */
     ...
     *                      length of the received object is greater than this value, a
