 ...
 * <p>
 * Please note that the serialized form this encoder produces is not compatible
 * with the standard {@link ObjectInputStream}. Please use {@link ObjectDecoder}
 * or {@link ObjectDecoderInputStream} to ensure the interoperability with this
 * encoder.
 *
 * @apiviz.landmark
