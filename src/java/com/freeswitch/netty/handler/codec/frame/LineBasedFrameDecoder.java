 ...
 * delimiter-based decoder, see {@link DelimiterBasedFrameDecoder}.
 */
public class LineBasedFrameDecoder extends FrameDecoder {
     ...
     *
     * @param maxLength the maximum length of the decoded frame. A
    ...
    private void fail(final ChannelHandlerContext ctx, String length) {
        Channels.fireExceptionCaught(ctx.getChannel(), new TooLongFrameException("frame length (" + length + ") exceeds the allowed maximum (" + maxLength + ')'));
    }
}
