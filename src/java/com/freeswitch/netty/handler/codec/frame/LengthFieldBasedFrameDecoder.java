 ...
 * proprietary client-server protocols. Here are some server that will give you
 * the basic idea on which option does what.
 *
 * <h3>2 bytes length field at offset 0, do not strip header</h3>
 *
 * The value of the length field in this server is <tt>12 (0x0C)</tt> which
 ...
 * field by specifying <tt>initialBytesToStrip</tt>. In this server, we
 ...
 * <tt>lengthAdjustment</tt>. Because the length value in this server message
 ...
 * header</h3>
 *
 * The following message is a simple variation of the first server. An extra
 ...
 * header</h3>
 *
 * This is an advanced server that shows the case where there is an extra
 ...
 *
 * Let's give another twist to the previous server. The only difference from
 * the previous server is that the length field represents the length of the
 * whole message instead of the message body, just like the third server. We
