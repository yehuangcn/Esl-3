...
/**
 * Decodes {@link ChannelBuffer}s into {@link HttpRequest}s and
 * {@link HttpChunk}s.
 * <p>
 ...
 * <td>The maximum length of the initial line (e.g. {@code "GET / HTTP/1.0"}) If
 * the length of the initial line exceeds this value, a
 ...
 * {@link HttpChunk}s. If the transfer encoding of the HTTP request is 'chunked'
 * already, each chunk will be split into smaller chunks if the length of the
 * chunk exceeds this value. If you prefer not to handle {@link HttpChunk}s in
 * your handler, insert {@link HttpChunkAggregator} after this decoder in the
 * {@link ChannelPipeline}.</td>
 * </tr>
 * </table>
 */
