...
import com.freeswitch.netty.buffer.CompositeChannelBuffer;
...
import static com.freeswitch.netty.handler.codec.http.HttpHeaders.is100ContinueExpected;

/**
 * A {@link ChannelHandler} that aggregates an {@link HttpMessage} and its
 * following {@link HttpChunk}s into a single {@link HttpMessage} with no
 * following {@link HttpChunk}s. It is useful when you don't want to take care
 * of HTTP messages whose transfer encoding is 'chunked'. Insert this handler
 * after {@link HttpMessageDecoder} in the {@link ChannelPipeline}:
 * <p>
 * <pre>
 ...
 *
 * @apiviz.landmark
 * @apiviz.has org.jboss.netty.handler.codec.http.HttpChunk oneway - - filters
 * out
 */
public class HttpChunkAggregator extends SimpleChannelUpstreamHandler implements LifeCycleAwareChannelHandler {
     ...
     *
     * @param maxContentLength the maximum length of the aggregated content. If the length of
