 ...
 * of the chunk exceeds this value. If you prefer not to handle
 * {@link HttpChunk}s in your handler, insert {@link HttpChunkAggregator} after
 ...
 * </p>
 * <p>
 * If you are writing an HTTP client that issues a <tt>HEAD</tt> request, please
 * use {@link HttpClientCodec} instead of this decoder. It will perform
