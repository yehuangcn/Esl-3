...
import static com.freeswitch.netty.handler.codec.http.cookie.CookieUtil.stripTrailingSeparatorOrNull;
 ...
 * {@link Cookie#rawValue()} will be used. Otherwise, {@link Cookie#value()}
...
public final class ClientCookieEncoder extends CookieEncoder {
	 ...
	 * @param cookies
	 *            some cookies
	 * @return a Rfc6265 style Cookie header value, null if no cookies are
	 *         passed.
	 */
