...
import static com.freeswitch.netty.handler.codec.http.cookie.CookieUtil.add;
import static com.freeswitch.netty.handler.codec.http.cookie.CookieUtil.addQuoted;
import static com.freeswitch.netty.handler.codec.http.cookie.CookieUtil.stripTrailingSeparator;
...
import com.freeswitch.netty.handler.codec.http.HttpHeaderDateFormat;
import com.freeswitch.netty.handler.codec.http.HttpRequest;

/**
 * A <a href="http://tools.ietf.org/html/rfc6265">RFC6265</a> compliant cookie
 * encoder to be used server side, so some fields are sent (Version is typically
 * ignored).
 *
 * As Netty's Cookie merges Expires and MaxAge into one single field, only
 * Max-Age field is sent.
 *
 * Note that multiple cookies are supposed to be sent at once in a single
 * "Set-Cookie" header.
 *
 * <pre>
 * // Example
...
public final class ServerCookieEncoder extends CookieEncoder {
	...
	/**
	 * Encodes the specified cookie name-value pair into a Set-Cookie header
	 * value.
	 *
	 * @param name
	 *            the cookie name
