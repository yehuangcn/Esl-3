...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
	 ...
	 *
	 * @throws NumberFormatException
	 *             if the message does not have the {@code "Content-Length"}
	 ...
	 *
	 * @param headerName
	 *            The header name being validated
	 */
	 ...
	 *
	 * @param name
	 *            The name of the headers to search
	 ...
	 *
	 * @param name
	 *            The name of the header being added
	 * @param value
	 ...
	 *            {@code true} if case should be ignored
