...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
     ...
     * <ul>
     * <li>set to {@code "keep-alive"} if {@code keepAlive} is
     * {@code true}.</li>
     * <li>remove otherwise.</li>
     * </ul>
     * </li>
     ...
     * existing header with the same name, the existing header is removed. If
     * the specified value is not a {@link String}, it is converted into a
     * {@link String} by {@link Object#toString()}, except for {@link Date} and
     * {@link Calendar} which are formatted to the date format defined in
     * <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>.
     */
     ...
     * existing header with the same name, the existing header is removed. This
     * getMethod can be represented approximately as the following code:
     * <p>
     * <pre>
    ...
    /**
     * Adds a new header with the specified name and value. If the specified
     * value is not a {@link String}, it is converted into a {@link String} by
     * {@link Object#toString()}, except for {@link Date} and {@link Calendar}
     * which are formatted to the date format defined in <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>.
     */
     ...
     * @throws NumberFormatException if there is no such header or the header value is not a
     *                               number
     */
    ...
    /**
     * Returns the date header value with the specified header name. If there
     * are more than one header value for the specified header name, the first
     * value is returned.
     *
     * @return the header value
     * @throws ParseException if there is no such header or the header value is not a
     *                        formatted date
     */
    ...
    /**
     * Sets a new date header with the specified name and value. If there is an
     * existing header with the same name, the existing header is removed. The
     * specified value is formatted as defined in <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>
     */
    ...
    /**
     * Sets a new date header with the specified name and values. If there is an
     * existing header with the same name, the existing header is removed. The
     * specified values are formatted as defined in <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>
     */
     ...
     * value is formatted as defined in <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>
     */
     ...
     * @throws NumberFormatException if the message does not have the {@code "Content-Length"}
    ...
    private static int getWebSocketContentLength(HttpMessage message) {
        ...
        if (message instanceof HttpRequest) {
            ...
            if (res.getStatus().getCode() == 101 && h.contains(Names.SEC_WEBSOCKET_ORIGIN) && h.contains(Names.SEC_WEBSOCKET_LOCATION)) {
                return 16;
            }
        }
     ...
     * header or the header is not a formatted date, the {@code defaultValue} is
     * returned.
     */
    ...
    static void validateHeaderValue(String headerValue) {
		 ...
		 *
		 * 0: Previous character was neither CR nor LF 1: The previous character
		 * was CR 2: The previous character was LF
		 */
        int state = 0;
    ...
    /**
     * Returns the value of a header with the specified name. If there are more
     * than one values for the specified name, the first value is returned.
     *
    ...
    /**
     * Returns a new {@link List} that contains all headers in this object. Note
     * that modifying the returned {@link List} will not affect the state of
     * this object. If you intend to enumerate over the header entries only, use
     * {@link #iterator()} instead, which has much less overhead.
     */
    ...
    /**
     * Returns a new {@link Set} that contains the names of all headers in this
     * object. Note that modifying the returned {@link Set} will not affect the
     * state of this object. If you intend to enumerate over the header entries
     * only, use {@link #iterator()} instead, which has much less overhead.
     */
     ...
     * {@link String} by {@link Object#toString()}, except in the cases of
     * {@link Date} and {@link Calendar}, which are formatted to the date format
     * defined in <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>.
     *
     ...
     * <p>
     * If there is an existing header with the same name, it is removed. If the
     * specified value is not a {@link String}, it is converted into a
     * {@link String} by {@link Object#toString()}, except for {@link Date} and
     * {@link Calendar}, which are formatted to the date format defined in
     * <a href=
     * "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">RFC2616</a>.
     ...
     * <p>
     * If there is an existing header with the same name, it is removed. This
     * getMethod can be represented approximately as the following code:
     * <p>
     * <pre>
     * headers.remove(name);
    ...
    /**
     * Cleans the current header entries and copies all header entries of the
