 ...
 * <p>
 * As a workaround to the <a href="http://netty.io/s/hashdos">HashDOS</a>
...
public class QueryStringDecoder {
     ...
     * {@code encodeURIComponent}, but not {@code escape}. For server in this
     ...
     *
     * @param c The ASCII character of the hexadecimal number to decode. Must
