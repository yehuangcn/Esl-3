 ...
 * under the License.
 */
package com.freeswitch.netty.handler.logging;
...
import com.freeswitch.netty.logging.InternalLogLevel;
import com.freeswitch.netty.logging.InternalLogger;
import com.freeswitch.netty.logging.InternalLoggerFactory;

/**
 * A {@link ChannelHandler} that logs all events via {@link InternalLogger}. By
 * default, all events are logged at <tt>DEBUG</tt> level. You can extend this
 * class and override {@link #log(ChannelEvent)} to change the default behavior.
 * 
 * @apiviz.landmark
 */
@Sharable
public class LoggingHandler implements ChannelUpstreamHandler, ChannelDownstreamHandler {
	 ...
	 *
	 * @param hexDump
	 *            {@code true} if and only if the hex dump of the received
	 *            message is logged
	 */
	...
	/**
	 * Returns the {@link InternalLogger} that this handler uses to log a
	 * {@link ChannelEvent}.
	 */
	...
	/**
	 * Returns the {@link InternalLogLevel} that this handler uses to log a
	 * {@link ChannelEvent}.
	 */
