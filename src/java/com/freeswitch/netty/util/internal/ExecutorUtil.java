 ...
 * their termination. An {@link Executor} which is not an
...
public final class ExecutorUtil {
     ...
     * {@link ExecutorService} and is shut down. Please note that this method
     * returns {@code false} if the specified {@code executor} is not an
    ...
    /**
     * Shuts down the specified executors using the given {@link ThreadLocal} to
