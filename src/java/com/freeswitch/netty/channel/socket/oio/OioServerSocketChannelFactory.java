 ...
 * if you opened two server ports such as 80 and 443, you will have two boss
 * threads. A boss thread accepts incoming connections until the port is
 ...
 * a {@link OioServerSocketChannelFactory} was created. Boss threads are
