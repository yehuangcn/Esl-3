 ...
 * when a {@link OioDatagramChannelFactory} was created (i.e.
 * {@code workerExecutor}.) Therefore, you should make sure the specified
 * {@link Executor} is able to lend the sufficient number of threads.
 * <p>
 ...
 * asynchronous operations. Any I/O requests such as {@code "write"} will be
 * performed in a blocking manner.
 *
 * @apiviz.landmark
 */
