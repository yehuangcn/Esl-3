...
import com.freeswitch.netty.channel.socket.ClientSocketChannelFactory;
...
public class NioClientSocketChannelFactory implements ClientSocketChannelFactory {
     ...
     * available processors is obtained by
     * {@link Runtime#availableProcessors()}.
     *
     * @param bossExecutor   the {@link Executor} which will execute the boss thread
     * @param workerExecutor the {@link Executor} which will execute the worker threads
     */
     ...
     * @param bossExecutor   the {@link Executor} which will execute the boss thread
     * @param workerExecutor the {@link Executor} which will execute the worker threads
     * @param bossCount      the maximum number of boss threads
     * @param workerCount    the maximum number of I/O worker threads
     */
     ...
     * @param bossExecutor the {@link Executor} which will execute the boss thread
     * @param bossCount    the maximum number of boss threads
     * @param workerPool   the {@link WorkerPool} to use to do the IO
     */
     ...
     * @param bossCount    the maximum number of boss threads
     * @param workerPool   the {@link WorkerPool} to use to do the IO
     * @param timer        the {@link Timer} to use to handle the connection timeouts
     */
     ...
     * Creates a new instance.
     *
     * @param bossPool   the {@link BossPool} to use to handle the connects
     * @param workerPool the {@link WorkerPool} to use to do the IO
     */
