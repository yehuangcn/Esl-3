...
public class NioClientBossPool extends AbstractNioBossPool<NioClientBoss> {
	 ...
	 *
	 * @param bossExecutor
	 *            the Executor to use for server the {@link NioClientBoss}
	 * @param bossCount
	 *            the number of {@link NioClientBoss} instances this
	 *            {@link NioClientBossPool} will hold
	 * @param timer
	 *            the Timer to use for handle connect timeouts
	 * @param determiner
	 *            the {@link ThreadNameDeterminer} to use for name the threads.
	 *            Use {@code null} if you not want to set one explicit.
	 */
	...
	/**
	 * Create a new instance using a new {@link HashedWheelTimer} and no
	 * {@link ThreadNameDeterminer}
	 *
	 * @param bossExecutor
	 *            the Executor to use for server the {@link NioClientBoss}
	 * @param bossCount
	 *            the number of {@link NioClientBoss} instances this
	 *            {@link NioClientBoss} will hold
	 */
