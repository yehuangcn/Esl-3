...
public class NioServerBossPool extends AbstractNioBossPool<NioServerBoss> {
     ...
     *
     * @param bossExecutor the {@link Executor} to use for server the
     *                     {@link NioServerBoss}
     * @param bossCount    the number of {@link NioServerBoss} instances this
     *                     {@link NioServerBossPool} will hold
