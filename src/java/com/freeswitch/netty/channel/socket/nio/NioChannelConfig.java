...
/**
 * Special {@link ChannelConfig} sub-type which offers extra methods which are
 * useful for NIO.
 */
public interface NioChannelConfig extends ChannelConfig {
     ...
     * {@link Channel#isWritable()} will start to return {@code false}.
     */
     ...
     * dropped down below this value, {@link Channel#isWritable()} will start to
     ...
     * queued in the write buffer exceeded the
     * {@linkplain #setWriteBufferHighWaterMark(int) high water mark} and then
     * dropped down below this value, {@link Channel#isWritable()} will start
     * toreturn {@code true} again.
     */
     ...
     * It improves memory utilization and write throughput depending on the
     * platform that JVM runs on. The default value is {@code 16}.
     */
