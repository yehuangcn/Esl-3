 ...
 * {@link #afterRemove(ChannelHandlerContext)} might lead to an unexpected
 * behavior. It is because the context object might not have been fully added to
 * the pipeline or the context object is not a part of the pipeline anymore
 * respectively.
 */
