 ...
 * flows forward from the first handler to the last handler in a
 ...
 * downstream event and say <strong>"an event goes downstream."</strong> (Please
 * refer to the diagram in {@link ChannelPipeline} for more explanation.)
 * <p>
 ...
 * event. If your client received a response from the server, it means your
 * client will be notified with an upstream event. Upstream events are often the
 * result of handler operations such as {@link InputStream#read(byte[])}, and
 ...
 * <td>a message object (e.g. {@link ChannelBuffer}) was received from a remote
 * peer</td>
 * </tr>
 * <tr>
 ...
 * <td><strong>Be aware that this event is fired from within the I/O thread. You
 * should never execute any heavy operation in there as it will block the
 * dispatching to other workers!</strong></td>
 * </tr>
 * <tr>
 * <td>{@code "channelClosed"}</td>
 * <td>{@link ChannelStateEvent}<br/>
 * (state = {@link ChannelState#OPEN OPEN}, value = {@code false})</td>
 * <td>a {@link Channel} was closed and all its related resources were
 * released</td>
 * </tr>
 * <tr>
 * <td>{@code "channelBound"}</td>
 * <td>{@link ChannelStateEvent}<br/>
 * (state = {@link ChannelState#BOUND BOUND}, value =
 * {@link SocketAddress})</td>
 * <td>a {@link Channel} is open and bound to a local address, but not
 * connected.</td>
 * <td><strong>Be aware that this event is fired from within the I/O thread. You
 * should never execute any heavy operation in there as it will block the
 * dispatching to other workers!</strong></td>
 ...
 * {@link SocketAddress})</td>
 * <td>a {@link Channel} is open, bound to a local address, and connected to a
 * remote address</td>
 * <td><strong>Be aware that this event is fired from within the I/O thread. You
 * should never execute any heavy operation in there as it will block the
 * dispatching to other workers!</strong></td>
 ...
 * <td>a {@link Channel}'s {@link Channel#getInterestOps() interestOps} was
 * changed</td>
 * </tr>
 * </table>
 * <p>
 * These two additional event types are used only for a parent channel which can
 * have a child channel (e.g. {@link ServerSocketChannel}).
 * <p>
 * <table border="1" cellspacing="0" cellpadding="6">
 * <tr>
 * <th>Event name</th>
 ...
 * <td>a child {@link Channel} was open (e.g. a server channel accepted a
 * connection.)</td>
 * </tr>
 * <tr>
 ...
 * <td>a child {@link Channel} was closed (e.g. the accepted connection was
 * closed.)</td>
 * </tr>
 * </table>
 *
 ...
 * <td>{@code "write"}</td>
 * <td>{@link MessageEvent}</td>
 * <td>Send a message to the {@link Channel}.</td>
 * </tr>
 * <tr>
 * <td>{@code "bind"}</td>
 * <td>{@link ChannelStateEvent}<br/>
