...
import com.freeswitch.netty.bootstrap.Bootstrap;
 ...
 * {@link ChannelEvent} you need to implement its sub-interfaces. There are two
 * sub-interfaces which handles a received event, one for upstream events and
 * the other for downstream events:
 * <ul>
 * <li>{@link ChannelUpstreamHandler} handles and intercepts an upstream
 * {@link ChannelEvent}.</li>
 * <li>{@link ChannelDownstreamHandler} handles and intercepts a downstream
 * {@link ChannelEvent}.</li>
 * </ul>
 * <p>
 * You will also find more detailed explanation from the documentation of each
 * sub-interface on how an event is interpreted when it goes upstream and
 ...
 * modify the pipeline dynamically, or store the information (attachment) which
 * is specific to the handler.
 * <p>
 ...
 * <p>
 * In the examples above which used an attachment or a {@link ChannelLocal}, you
 * might have noticed the {@code @Sharable} annotation.
 * <p>
