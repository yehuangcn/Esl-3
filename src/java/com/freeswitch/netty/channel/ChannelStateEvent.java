 ...
 * state. It can mean the notification of a change or the request for a change,
 * depending on whether it is an upstream event or a downstream event
 * respectively. Please refer to the {@link ChannelEvent} documentation to find
 * out what an upstream event and a downstream event are and what fundamental
