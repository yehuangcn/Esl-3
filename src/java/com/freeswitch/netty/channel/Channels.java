...
public final class Channels {
     ...
     *
     * @param cancellable {@code true} if and only if the returned future can be
    ...
    public static void fireChannelInterestChanged(Channel channel) {
        channel.getPipeline().sendUpstream(new UpstreamChannelStateEvent(channel, ChannelState.INTEREST_OPS, Channel.OP_READ));
    }
    ...
    public static void fireChannelInterestChanged(ChannelHandlerContext ctx) {
        ...
        ctx.sendUpstream(new UpstreamChannelStateEvent(ctx.getChannel(), ChannelState.INTEREST_OPS, Channel.OP_READ));
    }
     ...
     * @param future       the future which will be notified when the bind operation is
     *                     done
     * @param localAddress the local address to bind to
     */
     ...
     *
     * @param ctx    the context
     * @param future the future which will be notified when the unbind operation is
     *               done
     */
     ...
     *
     * @param ctx           the context
     * @param future        the future which will be notified when the connection attempt
     *                      is done
     * @param remoteAddress the remote address to connect to
     */
     ...
     *
     * @param ctx    the context
     * @param future the future which will be notified when the write operation is
     *               done
     */
     ...
     * @param channel       the channel to write a message
     * @param message       the message to write to the channel
     * @param remoteAddress the destination of the message. {@code null} to use the
