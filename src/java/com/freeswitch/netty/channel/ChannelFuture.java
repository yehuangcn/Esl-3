 ...
 * {@link ChannelFuture} instance which gives you the information about the
 ...
 * the future is done. {@link ChannelFutureListener} yields the best performance
 * and resource utilization because it does not block at all, but it could be
 * tricky to implement a sequential logic if you are not used to event-driven
 * programming.
 * <p>
 * By contrast, {@link #await()} is a blocking operation. Once called, the
 * caller thread blocks until the operation is done. It is easier to implement a
 * sequential logic with {@link #await()}, but the caller thread blocks
 ...
 * thread unless an {@link ExecutionHandler} is in the {@link ChannelPipeline}.
