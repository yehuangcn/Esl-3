...
/**
 * A {@link ChannelEvent} which represents the notification of the completion of
 * a write request on a {@link Channel}. This event is for going upstream only.
 * Please refer to the {@link ChannelEvent} documentation to find out what an
