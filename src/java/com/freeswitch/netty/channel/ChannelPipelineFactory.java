...
import com.freeswitch.netty.bootstrap.ConnectionlessBootstrap;
 ...
 * creates a new channel, it uses the {@link Bootstrap#getPipelineFactory()
 * "pipelineFactory"} property to create a new {@link ChannelPipeline} for each
 * new channel.
 *
