 ...
 * for each event type. This handler down-casts the received upstream event into
 * more meaningful sub-type event and calls an appropriate handler method with
 * the down-cast event. The names of the methods are identical to the upstream
 * event names, as introduced in the {@link ChannelEvent} documentation.
 * <p>
 ...
 * {@code super.handleUpstream()} so that other handler methods are invoked
 * properly:
 * </p>
 * 
 * <pre>
...
public class SimpleChannelUpstreamHandler implements ChannelUpstreamHandler {
	 ...
	 * <br/>
	 *
	 * <strong>Be aware that this event is fired from within the I/O thread. You
