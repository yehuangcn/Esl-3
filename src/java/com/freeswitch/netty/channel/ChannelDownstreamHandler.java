 ...
 * handleDownstream} may be invoked by more than one thread simultaneously. If
 * the handler accesses a shared resource or stores stateful information, you
 * might need proper synchronization in the handler implementation.
 *
